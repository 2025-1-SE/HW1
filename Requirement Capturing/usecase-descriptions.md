...
| 3. None | 4. 자전거 대여 정보 조회 화면 표시 |
| 5. 반납할 자전거 선택 | 6. 반납 가능한 대여소 목록 표시 |
| 7. 반납할 대여소 선택 | 8. 사용 시간에 따른 요금 계산 및 자동 결제 |
| 9. None | 10. 반납 완료 메시지 출력 |
| 11. None | 12. 근처 식당 추천 및 예약 서비스 연결 옵션 표시(선택 사항) |
| 13. None | 14. 대기 예약한 회원이 있는 경우 대기 1순위 회원에게 이메일 발송 |
...
| 6. 삭제할 특정 대여 기록 선택 | 7. 삭제 확인 메시지 표시 |
| 8. 삭제 확인 | 9. 선택한 대여 기록 삭제 |
