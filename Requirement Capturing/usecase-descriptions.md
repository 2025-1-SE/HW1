...
| Actor Action (회원) | System Response |
| --- | --- |
| 1. None | 2. 현재 대여 중인 자전거 목록 표시 |
| 3. None | 4. 각 항목에 대여소 이름, 대여소 위치, 자전거 ID, 자전거 제품명, 자전거 유형 표시 |
| 5. None | 6. 자전거 대여 정보 조회 화면 표시 |
| 7. 반납할 자전거 선택 | 8. 반납 가능한 대여소 목록 표시 |
| 9. 반납할 대여소 선택 | 10. 사용 시간에 따른 요금 계산 및 자동 결제 |
| 11. None | 12. 반납 완료 메시지 출력 |
| 13. None | 14. 근처 식당 추천 및 예약 서비스 연결 옵션 표시(선택 사항) |
| 15. None | 16. 대기 예약한 회원이 있는 경우 대기 1순위 회원에게 이메일 발송 |
...
| Actor Action (회원) | System Response |
| --- | --- |
| 1. None | 2. 이용 내역 조회 페이지 표시 |
| 3. None | 4. 날짜별로 정렬된 과거 대여 기록 표시 |
| 5. 정렬 옵션(대여소별) 선택(선택 사항) | 6. 대여소별로 정렬된 이용 내역 표시 |
| 7. 삭제할 특정 대여 기록 선택(선택 사항) | 8. 삭제 확인 메시지 표시 |
| 9. 삭제 확인 | 10. 선택한 대여 기록 삭제 |
