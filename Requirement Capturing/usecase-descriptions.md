...
| 3. 특정 대여소 클릭 | 4. 대여소 상세 정보 출력 |
| 5. 자전거 대여 버튼 클릭 | 6. 결과 팝업창 출력 및 대여소 상세 정보 화면 새로고침 |
| 7. 자전거 예약 대기 버튼 클릭 | 8. 결과 팝업창 출력 및 대여소 상세 정보 화면 새로고침 |

| Actor Action (회원) | System Response |
| --- | --- |
| 1. None | 2. 자전거 대여, 자전거 에약 대기 결과 이메일이 발송된다. |

### 자전거 예약 대기 정보 조회 및 예약 대기 취소소

| Actor Action(회원) | System Response |
| --- | --- |
| 1. None | 2. 예약 대기 정보 조회 페이지 표시 |
| 3. 취소 버튼 클릭 | 4. 결과 팝업창 출력 및 자전거 예약 대기 정보 조회 화면 새로고침 |
...
| Actor Action (회원) | System Response |
| --- | --- |
| 1. None | 2. 대기 중인 자전거가 예약 되었다는 이메일이 발송된다. |
...
| 4. 정렬 옵션(대여소별) 선택 | 5. 대여소별로 정렬된 대여 기록 표시 |
| 6. 삭제할 특정 대여 기록 선택 | 7. 삭제 확인 버튼 표시 |
| 8. 삭제 버튼 클릭 | 9. 대여 기록 페이지 새로고침 |
